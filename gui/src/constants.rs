...
//---------------------------------------------------------------------------------------------------- `egui` Spacing
pub static SPACING: Lazy<Spacing> = Lazy::new(|| Spacing {
    scroll: ScrollStyle {
        bar_width: 12.5,
        ..ScrollStyle::solid()
    },
...
//---------------------------------------------------------------------------------------------------- Fonts
pub const FONT_SOURCECODE_PRO: &[u8] =
    include_bytes!("../../assets/fonts/SourceCodePro-Regular.otf");
pub const FONT_SOURCECODE_CN: &[u8] =
    include_bytes!("../../assets/fonts/SourceHanSansCN-Regular.otf");
pub const FONT_SOURCECODE_KR: &[u8] =
    include_bytes!("../../assets/fonts/SourceHanSansKR-Regular.otf");
pub const FONT_SOURCECODE_JP: &[u8] =
    include_bytes!("../../assets/fonts/SourceHanSansJP-Regular.otf");
...
pub const SLIDER_CIRCLE_INACTIVE: egui::Stroke = Stroke {
    width: 1.5,
    color: BLACK,
};
pub const SLIDER_CIRCLE_HOVERED: egui::Stroke = Stroke {
    width: 2.0,
    color: BLACK,
};
pub const SLIDER_CIRCLE_ACTIVE: egui::Stroke = Stroke {
    width: 2.5,
    color: WHITE,
};
