...
//
// Not ideal.
pub static RESET_STATE: Lazy<ResetStateLock> =
    Lazy::new(|| ResetStateLock(RwLock::new(ResetState::new())));
...
impl ResetStateLock {
    ...
    pub fn try_read(
        ...
        RwLockReadGuard<'static, ResetState>,
        TryLockError<RwLockReadGuard<'static, ResetState>>,
    > {
        self.0.try_read()
    }
    ...
    pub(crate) fn try_write(
        ...
        RwLockWriteGuard<'static, ResetState>,
        TryLockError<RwLockWriteGuard<'static, ResetState>>,
    > {
        self.0.try_write()
    }
}
